# Fact check — narration ↔ source (Short cut)

Derivative Short of the full portrait reel. Kept beats: B00, B01, B04, B05,
B06, B07, B09, B11. Rows tied to dropped beats (B02 anatomy, B03 pipeline,
B08 CALLS schema, B10 Your-Turn dry-run) remain in the table as evidence for
the doctrine the retained beats invoke — e.g. B09's verdict still names the
CALLS.json null verdict slot — but no narration in this Short asserts details
that were only present in dropped beats.
