...
`f243831c7108064b81c54617979906155fbe0e7811ea3dfcc5ff29f933a16344`; updated 2026-09-12
with a camera rule correction — static camera on ordinary 2D beats, orbit only on 3D beats;
no beat in this Short narrates the camera rule so all claims below remain accurate) or
