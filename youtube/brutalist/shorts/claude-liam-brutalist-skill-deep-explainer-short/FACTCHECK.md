# FACTCHECK.md — The deep-explainer Skill — Short

This Short retains a subset of the long's beats unchanged. Every claim in
the retained narration is checked against `skills/make/deep-explainer/SKILL.md`
at SHA-256 `c268b6d698fcf117f2cb89f4f5c9efb1bed007c294ea64a5016726a4988c601e`.
Only the retained beats are audited here; dropped-beat claims are held in
the parent's FACTCHECK.md.
...
| B07 | "The old skill had a vox quota — twenty to twenty-five percent" | HOLDS | Section "THE BEAT MIX — no quota (VOX LAW governs)": "The vox percentage is dead (2026-09-02). It used to say ~20–25% of body beats should be pantry stills…" | — |
...
| B14 | "Bookends INHERITED", "Middle OWNED", "Gate D1", "Gate D2" — all lands on evidence retained in this Short | HOLDS | Delivered by retained B03 (inheritance), B06/B07 (owned middle), B10 (Gate D1), B11 (Gate D2) | — |
...
- No claim that Kokoro is unlimited or that any Claude subscription tier is described.
- No claim that this Short is published or has a public URL.
...
- No claim about a full end-to-end deep-explainer run; B13 (which held the
  extended limitation callback) was dropped for length, but the Short does
  not present its evidence as a live run either.

## Coherence of the cut

- B01's "two hard gates" promise is delivered by retained B10 and B11.
- B14's "Bookends inherited" line lands on retained B03.
- B14's "Middle OWNED" line lands on retained B06 and B07.
- No numbered transition, "as we just saw" callback, or dropped-beat
  reference remains in the retained narration.

## Unverified / follow-up

- The "7.2 s" figure in B11 comes from the SKILL's own illustrative example
  (`reference/shopping-list.md`). It is a shape-of-the-rule number, not a
  real production measurement. Narration frames it accordingly.
