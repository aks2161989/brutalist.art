...
export const BrutalistHesitantWriter: React.FC<BrutalistHesitantWriterProps> = (props) => {
  ...
  // Everything scales off the canvas against the aspect-appropriate design reference.
  // Portrait (h>w) uses a 1080x1920 reference so text does not collapse to ~56%.
