...
// ── claude-liam-brutalist-what-is-brutalist — reel-local components ──
import {
  WibRecipe,     wibRecipeSchema,
  WibPipeline,   wibPipelineSchema,
  WibChange,     wibChangeSchema,
  WibDivision,   wibDivisionSchema,
  WibNotClaims,  wibNotClaimsSchema,
  WibVerdict,    wibVerdictSchema,
  WibOutro,      wibOutroSchema,
} from './WhatIsBrutalist';
...
export const RemotionRoot: React.FC = () => {
  return (
    <>
      ...
      {/* ── claude-liam-brutalist-what-is-brutalist — reel-local compositions ── */}
      <Folder name="WhatIsBrutalist">
        <Composition id="WibRecipe" component={WibRecipe}
          durationInFrames={780} fps={30} width={1920} height={1080}
          schema={wibRecipeSchema}
          defaultProps={wibRecipeSchema.parse({})} />
        <Composition id="WibRecipe916" component={WibRecipe}
          durationInFrames={780} fps={30} width={1080} height={1920}
          schema={wibRecipeSchema}
          defaultProps={wibRecipeSchema.parse({})} />
        <Composition id="WibPipeline" component={WibPipeline}
          durationInFrames={780} fps={30} width={1920} height={1080}
          schema={wibPipelineSchema}
          defaultProps={wibPipelineSchema.parse({})} />
        <Composition id="WibPipeline916" component={WibPipeline}
          durationInFrames={780} fps={30} width={1080} height={1920}
          schema={wibPipelineSchema}
          defaultProps={wibPipelineSchema.parse({})} />
        <Composition id="WibChange" component={WibChange}
          durationInFrames={780} fps={30} width={1920} height={1080}
          schema={wibChangeSchema}
          defaultProps={wibChangeSchema.parse({})} />
        <Composition id="WibChange916" component={WibChange}
          durationInFrames={780} fps={30} width={1080} height={1920}
          schema={wibChangeSchema}
          defaultProps={wibChangeSchema.parse({})} />
        <Composition id="WibDivision" component={WibDivision}
          durationInFrames={900} fps={30} width={1920} height={1080}
          schema={wibDivisionSchema}
          defaultProps={wibDivisionSchema.parse({})} />
        <Composition id="WibDivision916" component={WibDivision}
          durationInFrames={900} fps={30} width={1080} height={1920}
          schema={wibDivisionSchema}
          defaultProps={wibDivisionSchema.parse({})} />
        <Composition id="WibNotClaims" component={WibNotClaims}
          durationInFrames={780} fps={30} width={1920} height={1080}
          schema={wibNotClaimsSchema}
          defaultProps={wibNotClaimsSchema.parse({})} />
        <Composition id="WibNotClaims916" component={WibNotClaims}
          durationInFrames={780} fps={30} width={1080} height={1920}
          schema={wibNotClaimsSchema}
          defaultProps={wibNotClaimsSchema.parse({})} />
        <Composition id="WibVerdict" component={WibVerdict}
          durationInFrames={600} fps={30} width={1920} height={1080}
          schema={wibVerdictSchema}
          defaultProps={wibVerdictSchema.parse({})} />
        <Composition id="WibVerdict916" component={WibVerdict}
          durationInFrames={600} fps={30} width={1080} height={1920}
          schema={wibVerdictSchema}
          defaultProps={wibVerdictSchema.parse({})} />
        <Composition id="WibOutro" component={WibOutro}
          durationInFrames={360} fps={30} width={1920} height={1080}
          schema={wibOutroSchema}
          defaultProps={wibOutroSchema.parse({})} />
        <Composition id="WibOutro916" component={WibOutro}
          durationInFrames={360} fps={30} width={1080} height={1920}
          schema={wibOutroSchema}
          defaultProps={wibOutroSchema.parse({})} />
      </Folder>
