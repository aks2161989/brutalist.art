...
const Note: React.FC<{ text: string; o: number }> = ({ text, o }) =>
  text ? (
    <div style={{
      ...
      fontFamily: SERIF, fontSize: 38, color: SOFT, lineHeight: 1.3,
  ...
  return (
    <AbsoluteFill style={{ background: BG }}>
      ...
      <div style={{
        ...
        <div style={{
          fontFamily: SERIF, fontSize: 40, color: ACC, textAlign: 'center',
...
export const TtFrontLoaded: React.FC<TtFrontLoadedProps> = ({
  ...
  const baseBen  = 830;      // baseline of the lower (benefit) track
  ...
  return (
    <AbsoluteFill style={{ background: BG }}>
      ...
      <svg width={CW} height={CH} style={{ position: 'absolute', inset: 0 }}>
        {/* Span divider */}
        <line x1={mid} y1={330} x2={mid} y2={905} stroke={GHOST} strokeWidth={1} strokeDasharray="6 8" />
        {/* Baselines */}
      ...
      {[L + (mid - L) / 2, mid + (R - mid) / 2].map((x, i) => (
        <div key={i} style={{
          position: 'absolute', left: x - 160, width: 320, top: 938, textAlign: 'center',
      ...
      <div style={{
        ...
        fontFamily: SERIF, fontSize: 38, color: ACC, opacity: cl(costRise * 1.4),
      }}>{costLabel}</div>
      <div style={{
      ...
      <div style={{
        ...
        fontFamily: SERIF, fontSize: 40, color: ACC, lineHeight: 1.22, opacity: bandIn,
      }}>{bandLabel}</div>
...
export const TtCorrection: React.FC<TtCorrectionProps> = ({
  ...
  const cpx = corrected.length <= 90 ? 54 : corrected.length <= 140 ? 46 : 40;
  ...
  return (
    <AbsoluteFill style={{ background: BG }}>
      ...
      <div style={{
        position: 'absolute', top: 232, left: SAFE, fontFamily: SANS, fontSize: 26,
      ...
      <div style={{
        ...
        <div style={{
          fontFamily: SANS, fontSize: 24, letterSpacing: '0.22em', color: ACC,
        ...
        {citation ? (
          <div style={{ fontFamily: SANS, fontSize: 26, color: SOFT, marginTop: 18, opacity: stampIn }}>{citation}</div>
        ) : null}
      </div>
    ...
    return (
      <div key={d.label} style={{ position: 'absolute', left: x, top, width: 300 }}>
        ...
        <div style={{
          ...
          background: accent ? ACC : INK, opacity: accent ? 0.9 : 0.82,
        }} />
  ...
  return (
    <AbsoluteFill style={{ background: BG }}>
      ...
      <svg width={CW} height={CH} style={{ position: 'absolute', inset: 0, pointerEvents: 'none' }}>
        <line x1={1130} y1={base} x2={1130 + 300 * flatIn} y2={base} stroke={ACC} strokeWidth={5} />
      </svg>
      <div style={{
        position: 'absolute', left: 1454, top: base - 30, width: 370,
        fontFamily: SERIF, fontSize: 36, color: ACC, lineHeight: 1.2, opacity: flatIn,
      }}>{flatLabel}</div>
  ...
  return (
    <AbsoluteFill style={{ background: BG }}>
      ...
      <div style={{
        ...
        fontFamily: SERIF, fontSize: 60, color: ACC,
      }}>{showValue
          ? <>{eff.toFixed(2)}<span style={{ fontSize: 34, color: SOFT, marginLeft: 10 }}>{unit}</span></>
          : <span style={{ fontSize: 46, color: ACC }}>{(f < 0.5 ? qualitative[i] : qualitative[Math.min(qualitative.length - 1, i + 1)]) ?? ''}</span>}</div>
      <div style={{
  ...
  return (
    <AbsoluteFill style={{ background: BG }}>
      ...
      <div style={{
        ...
        fontFamily: SERIF, color: ACC, fontSize: 300 * bigScale, lineHeight: 1,
        opacity: bigIn,
      }}>{headline}</div>
      <div style={{
      ...
      <div style={{
        ...
        fontFamily: SERIF, fontSize: 44, color: ACC, lineHeight: 1.26, opacity: corrIn,
  ...
  return (
    <AbsoluteFill style={{ background: BG }}>
      ...
      <div style={{
        ...
        <span style={{ fontFamily: SERIF, fontSize: 42, color: ACC, marginRight: 18 }}>*</span>
        <span style={{ fontFamily: SANS, fontSize: 36, color: INK, lineHeight: 1.2 }}>
          {shown}{caret ? <span style={{ color: ACC }}>|</span> : null}
        </span>
      </div>
      ...
      <div style={{
        ...
        <div style={{
          fontFamily: SERIF, fontSize: 110, color: ACC, lineHeight: 1.06,
        ...
        return (
          <div key={k} style={{
            ...
            <div style={{
              ...
              color: r.accent ? ACC : SOFT, textTransform: 'uppercase',
    ...
    <AbsoluteFill style={{ background: BG }}>
        ...
        return (
          <div key={k}>
            ...
            <div style={{
              ...
              fontFamily: SERIF, fontSize: 52, color: col, opacity: grow,
              whiteSpace: 'nowrap',
            }}>{d.display}</div>
          </div>
        );
      ...
      {caveat ? (
        <div style={{
          ...
          <span style={{ color: ACC }}>&#42;&nbsp;</span>{caveat}
        </div>
      ) : null}
