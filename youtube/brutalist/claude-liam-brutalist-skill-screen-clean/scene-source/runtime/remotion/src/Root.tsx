...
import {SkillTeardownAnatomy916, skillTeardownAnatomy916Schema} from './scenes/SkillTeardownAnatomy916';
import {SkillTeardownPipeline916, skillTeardownPipeline916Schema} from './scenes/SkillTeardownPipeline916';
import {SkillTeardownMechanism916, skillTeardownMechanism916Schema} from './scenes/SkillTeardownMechanism916';
    ...
    <>
      ...
      <Folder name="SkillTeardown-Generic">
        ...
        <Composition id="SkillTeardownAnatomy916" component={SkillTeardownAnatomy916}
          ...
          schema={skillTeardownAnatomy916Schema}
          defaultProps={skillTeardownAnatomy916Schema.parse({})} />
        <Composition id="SkillTeardownPipeline916" component={SkillTeardownPipeline916}
          durationInFrames={600} fps={30} width={1080} height={1920}
          schema={skillTeardownPipeline916Schema}
          defaultProps={skillTeardownPipeline916Schema.parse({})} />
        <Composition id="SkillTeardownMechanism916" component={SkillTeardownMechanism916}
          durationInFrames={600} fps={30} width={1080} height={1920}
          schema={skillTeardownMechanism916Schema}
          defaultProps={skillTeardownMechanism916Schema.parse({})} />
      </Folder>
