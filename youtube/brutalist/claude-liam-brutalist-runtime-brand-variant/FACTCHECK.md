...
| 23 | "Copies any build scripts (build_deck.py, render.py, make_audio*.py) from the canonical into the variant folder" | `brand_variant.py:53-59` `copy_build_scripts()`; called at `brand_variant.py:138-140` | ✅ (demo/canonical has none, so no 'copied build scripts' line appears in RUN-LOG — function returns empty list) |
