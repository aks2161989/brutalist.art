# FACTCHECK — The finance Skill teardown

Every factual claim in `SCRIPT.md` is verified against a specific span of the
primary source, `skills/make/finance/SKILL.md` (SHA-256 as recorded in
`SOURCE-SNAPSHOT.json`). Nothing in the film asserts a claim not present there.
