...
export const BrutalistHesitantWriter: React.FC<BrutalistHesitantWriterProps> = (props) => {
  ...
  // Everything scales off the canvas against an aspect-aware design reference:
  // 1920x1080 for landscape, 1080x1920 for portrait (else portrait collapses to
  // scale 0.5625 and the serif can't fill the safe area).
