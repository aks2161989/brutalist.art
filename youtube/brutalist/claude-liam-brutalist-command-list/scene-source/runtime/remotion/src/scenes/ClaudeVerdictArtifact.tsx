...
export const ClaudeVerdictArtifact: React.FC<ClaudeVerdictArtifactProps> = ({
  ...
  // Fill the frame: ~90% of width. Cap raised to 1750 so the card fills
  // the SAFE inset at 1920x1080 comps (SAFE.w ≈ 1728 → cardW cap ≥ that).
  const cardW = Math.min(width * 0.9, 1750);
