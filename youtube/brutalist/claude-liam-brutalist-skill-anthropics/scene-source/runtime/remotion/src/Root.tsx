...
// ── claude-liam-brutalist-skill-anthropics — reel-local outro (HAI channel) ──
import {AntOutro, antOutroSchema} from './scenes/AntOutro';
  ...
  return (
    <>
      ...
      <Folder name="SkillTeardown-Generic">
        ...
        {/* Native portrait variants — same component, useVideoConfig scales layout. */}
        <Composition id="SkillTeardownAnatomy916" component={SkillTeardownAnatomy}
          durationInFrames={600} fps={30} width={1080} height={1920}
          schema={skillTeardownAnatomySchema}
          defaultProps={skillTeardownAnatomySchema.parse({})} />
        <Composition id="SkillTeardownPipeline916" component={SkillTeardownPipeline}
          durationInFrames={600} fps={30} width={1080} height={1920}
          schema={skillTeardownPipelineSchema}
          defaultProps={skillTeardownPipelineSchema.parse({})} />
        <Composition id="SkillTeardownMechanism916" component={SkillTeardownMechanism}
          durationInFrames={600} fps={30} width={1080} height={1920}
          schema={skillTeardownMechanismSchema}
          defaultProps={skillTeardownMechanismSchema.parse({})} />
      </Folder>
      {/* ── claude-liam-brutalist-skill-anthropics — reel-local outro (HAI) ── */}
      <Folder name="AnthropicsSkill">
        <Composition id="AntOutro" component={AntOutro}
          durationInFrames={360} fps={30} width={1920} height={1080}
          schema={antOutroSchema}
          defaultProps={antOutroSchema.parse({})} />
        <Composition id="AntOutro916" component={AntOutro}
          durationInFrames={360} fps={30} width={1080} height={1920}
          schema={antOutroSchema}
          defaultProps={antOutroSchema.parse({})} />
      </Folder>
