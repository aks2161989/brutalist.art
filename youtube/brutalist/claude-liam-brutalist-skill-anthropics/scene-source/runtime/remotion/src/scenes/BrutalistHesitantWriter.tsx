...
export const BrutalistHesitantWriter: React.FC<BrutalistHesitantWriterProps> = (props) => {
  ...
  // Everything scales off the canvas against a design reference. Landscape
  // uses 1920x1080; portrait uses the 1080x1920 native reference so text
  // doesn't get shrunk to landscape-shorter-side proportions on 9:16.
