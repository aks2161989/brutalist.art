...
export const BrutalistHesitantWriter: React.FC<BrutalistHesitantWriterProps> = (props) => {
  ...
  // Everything scales off the canvas against a design reference that swaps to
  // 1080x1920 in portrait so the serif fills the 9:16 safe area instead of
  // collapsing to the 0.5625 min(1080/1920, 1920/1080) landscape scale.
