...
`7e3ab3a9a8de25ac27aa23bd67e720b90fe41999131005e73225fde403ef9b54` (on-disk
this invocation; previous SHA was `c268b6d698fcf117f2cb89f4f5c9efb1bed007c294ea64a5016726a4988c601e`).
Direct quotes are shown on screen in the mechanism beats and match the current
SKILL.md verbatim. B07 narration and on-screen text updated to reflect the SKILL.md
change that shifted body framing to "executed examples, data and diagrams first."
...
| B07 | "The updated doctrine names the preferred mode: executed examples, data, and diagrams." | HOLDS | Current SKILL.md opening: "Here the middle is a 5–10 minute documentary-register body built from executed examples, data and diagrams." Narration paraphrases; on-screen body text is direct. | Added in this invocation to reflect SKILL.md change. |
