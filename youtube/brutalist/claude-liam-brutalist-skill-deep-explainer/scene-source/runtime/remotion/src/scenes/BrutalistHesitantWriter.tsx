...
export const BrutalistHesitantWriter: React.FC<BrutalistHesitantWriterProps> = (props) => {
  ...
  // Everything scales off the canvas against a design reference. Landscape and
  // square compose against 1920x1080; portrait 9:16 uses 1080x1920 so the serif
  // fills the safe area instead of collapsing to 0.5625.
