...
- **`skills/make/deep-explainer/SKILL.md`** — SHA-256 `c268b6d698fcf117f2cb89f4f5c9efb1bed007c294ea64a5016726a4988c601e`
  Read in full. Every quote in FACTCHECK.md is verbatim or near-verbatim from this
  file. Repo-relative path in the public toolkit:
