...
// ── claude-liam-brutalist-download-and-set-up — reel-local components ──
import {
  DbcPasteReady,  dbcPasteReadySchema,
  DbcCloneTree,   dbcCloneTreeSchema,
  DbcDoctor,      dbcDoctorSchema,
  DbcLanes,       dbcLanesSchema,
  DbcNotClaims,   dbcNotClaimsSchema,
  DbcVerdict,     dbcVerdictSchema,
  DbcOutro,       dbcOutroSchema,
} from './DownloadBrutalist';
...
export const RemotionRoot: React.FC = () => {
  return (
    <>
      ...
      />
      {/* ── claude-liam-brutalist-download-and-set-up — reel-local compositions ── */}
      <Folder name="DownloadBrutalist">
        <Composition id="DbcPasteReady" component={DbcPasteReady}
          durationInFrames={780} fps={30} width={1920} height={1080}
          schema={dbcPasteReadySchema}
          defaultProps={dbcPasteReadySchema.parse({})} />
        <Composition id="DbcPasteReady916" component={DbcPasteReady}
          durationInFrames={780} fps={30} width={1080} height={1920}
          schema={dbcPasteReadySchema}
          defaultProps={dbcPasteReadySchema.parse({})} />
        <Composition id="DbcCloneTree" component={DbcCloneTree}
          durationInFrames={780} fps={30} width={1920} height={1080}
          schema={dbcCloneTreeSchema}
          defaultProps={dbcCloneTreeSchema.parse({})} />
        <Composition id="DbcCloneTree916" component={DbcCloneTree}
          durationInFrames={780} fps={30} width={1080} height={1920}
          schema={dbcCloneTreeSchema}
          defaultProps={dbcCloneTreeSchema.parse({})} />
        <Composition id="DbcDoctor" component={DbcDoctor}
          durationInFrames={900} fps={30} width={1920} height={1080}
          schema={dbcDoctorSchema}
          defaultProps={dbcDoctorSchema.parse({})} />
        <Composition id="DbcDoctor916" component={DbcDoctor}
          durationInFrames={900} fps={30} width={1080} height={1920}
          schema={dbcDoctorSchema}
          defaultProps={dbcDoctorSchema.parse({})} />
        <Composition id="DbcLanes" component={DbcLanes}
          durationInFrames={900} fps={30} width={1920} height={1080}
          schema={dbcLanesSchema}
          defaultProps={dbcLanesSchema.parse({})} />
        <Composition id="DbcLanes916" component={DbcLanes}
          durationInFrames={900} fps={30} width={1080} height={1920}
          schema={dbcLanesSchema}
          defaultProps={dbcLanesSchema.parse({})} />
        <Composition id="DbcNotClaims" component={DbcNotClaims}
          durationInFrames={900} fps={30} width={1920} height={1080}
          schema={dbcNotClaimsSchema}
          defaultProps={dbcNotClaimsSchema.parse({})} />
        <Composition id="DbcNotClaims916" component={DbcNotClaims}
          durationInFrames={900} fps={30} width={1080} height={1920}
          schema={dbcNotClaimsSchema}
          defaultProps={dbcNotClaimsSchema.parse({})} />
        <Composition id="DbcVerdict" component={DbcVerdict}
          durationInFrames={600} fps={30} width={1920} height={1080}
          schema={dbcVerdictSchema}
          defaultProps={dbcVerdictSchema.parse({})} />
        <Composition id="DbcVerdict916" component={DbcVerdict}
          durationInFrames={600} fps={30} width={1080} height={1920}
          schema={dbcVerdictSchema}
          defaultProps={dbcVerdictSchema.parse({})} />
        <Composition id="DbcOutro" component={DbcOutro}
          durationInFrames={360} fps={30} width={1920} height={1080}
          schema={dbcOutroSchema}
          defaultProps={dbcOutroSchema.parse({})} />
        <Composition id="DbcOutro916" component={DbcOutro}
          durationInFrames={360} fps={30} width={1080} height={1920}
          schema={dbcOutroSchema}
          defaultProps={dbcOutroSchema.parse({})} />
      </Folder>
