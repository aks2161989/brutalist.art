...
# 2. Point Remotion at a chrome-headless-shell wrapper with
#    --single-process (feedback_chrome_sandbox).
cat > /tmp/chrome-wrapper.sh <<'W'
#!/usr/bin/env bash
...
export ART_CHROME=/tmp/chrome-wrapper.sh
