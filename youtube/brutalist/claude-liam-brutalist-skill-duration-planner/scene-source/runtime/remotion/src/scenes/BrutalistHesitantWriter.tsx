...
export const BrutalistHesitantWriter: React.FC<BrutalistHesitantWriterProps> = (props) => {
  ...
  // Everything scales off the canvas against a 1920x1080 landscape reference,
  // OR a 1080x1920 portrait reference when the canvas is taller than wide.
  // Without the portrait branch, 9:16 collapses scale to 0.5625 and the serif
  // shrinks to half the safe area (see feedback_hesitant_writer_portrait_scale).
