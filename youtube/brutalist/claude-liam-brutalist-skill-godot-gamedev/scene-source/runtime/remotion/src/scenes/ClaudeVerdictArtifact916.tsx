...
export const ClaudeVerdictArtifact916: React.FC<ClaudeVerdictArtifact916Props> = ({
  ...
  const PAD_V = height * 0.035;
  const FONT_TITLE = height * 0.026;
  const FONT_HEADING = height * 0.040;
  const FONT_LINE = height * 0.028;
  ...
  return (
    <AbsoluteFill style={{ background: '#F2F0E9', alignItems: 'center', justifyContent: 'center' }}>
      <div style={{
        ...
        borderRadius: 20,
        boxShadow: '0 8px 16px rgba(61,57,41,0.10)',
