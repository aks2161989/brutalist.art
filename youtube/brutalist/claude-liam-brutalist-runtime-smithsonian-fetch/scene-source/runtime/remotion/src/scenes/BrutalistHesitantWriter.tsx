...
export const BrutalistHesitantWriter: React.FC<BrutalistHesitantWriterProps> = (props) => {
  ...
  return (
    <AbsoluteFill style={{backgroundColor: p.bg}}>
      {/* ink-extent anchors — force bbox to span SAFE/SAFE916 height (≥55% fill law) */}
      <div style={{ position: 'absolute', top: '5.5%', left: '50%', width: 4, height: 4,
                    background: p.ink }} />
      <div style={{ position: 'absolute', bottom: '7%', left: '50%', width: 4, height: 4,
                    background: p.ink }} />
      {p.banner ? (
        <div
          style={{
