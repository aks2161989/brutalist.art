...
/**
 * ClaudeTitleOutroHAI — title-restate outro for @HumanitariansAI Brutalist playlist reels.
 *
 * Handle hardcoded to '@HumanitariansAI'. Never use ClaudeTitleOutro for HAI reels —
 * that component hardcodes @NikBearBrown per OUTRO-LOCK.md.
 *
 * Mascot, polarity, and jingle seeded by slug (same deterministic scheme as ClaudeTitleOutro).
 */
