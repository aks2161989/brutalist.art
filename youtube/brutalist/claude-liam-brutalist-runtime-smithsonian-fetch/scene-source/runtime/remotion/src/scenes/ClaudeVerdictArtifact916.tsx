...
export const ClaudeVerdictArtifact916: React.FC<ClaudeVerdictArtifact916Props> = ({
  ...
  return (
    <AbsoluteFill style={{ background: '#F2F0E9', alignItems: 'center', justifyContent: 'center' }}>
      ...
      <div style={{ position: 'absolute', top: '5.5%', left: '50%', width: 4, height: 4, background: CLAUDE.INK }} />
      <div style={{ position: 'absolute', bottom: '5.5%', left: '50%', width: 4, height: 4, background: CLAUDE.INK }} />
      <div style={{
        width: CARD_W,
