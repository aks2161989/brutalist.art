...
export const FormBCard916: React.FC<FormBCard916Props> = ({ title, items, dark }) => {
  ...
  return (
    <AbsoluteFill style={{ background: bg }}>
      ...
      <div style={{ position: 'absolute', top: safeT, left: safeL, right: safeL, height: 4, background: fg, opacity: 0.5 }} />
      <div style={{ position: 'absolute', bottom: safeB, left: safeL, right: safeL, height: 4, background: fg, opacity: 0.5 }} />
