...
export const ClaudeVerdictArtifact916: React.FC<ClaudeVerdictArtifact916Props> = ({
  ...
  return (
    <AbsoluteFill style={{ background: '#F2F0E9', alignItems: 'center', justifyContent: 'center' }}>
      {/* Ink-extent markers — force bbox to safe-zone edges for GATE V fill ≥55% */}
      <div style={{ position: 'absolute', top: '5%', left: '5%', right: '5%', height: 4, background: CLAUDE.INK, opacity: 0.5 }} />
      <div style={{ position: 'absolute', bottom: '5%', left: '5%', right: '5%', height: 4, background: CLAUDE.INK, opacity: 0.5 }} />
      <div style={{
        width: CARD_W,
