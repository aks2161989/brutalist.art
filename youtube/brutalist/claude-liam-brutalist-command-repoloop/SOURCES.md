...
SHA-256 values captured at SOURCE-SNAPSHOT.json snapshot time (2026-09-13T02:50:49Z;
sources changed since 2026-09-10 build — see Re-verification note in README.md).

| Repo-relative path | SHA-256 (current) |
|---|---|
