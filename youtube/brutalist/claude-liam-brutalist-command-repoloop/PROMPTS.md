...
{
  "text": "repoloop.sh\nrenders films.",
  "triggerWords": "renders, films",
  "replacementWords": "spawns, workers",
  "seed": "repoloop-b01",
  "face": "serif",
  "fontSize": 240,
  "lineSpacing": 2.6,
...
- Neither `renders` nor `films` appears in the preserved title/prefix
...
- Final sentence, after replacement: `repoloop.sh spawns workers.` —
