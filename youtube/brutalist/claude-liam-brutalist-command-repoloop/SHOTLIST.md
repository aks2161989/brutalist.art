...
| B01 | `BrutalistHesitantWriter` | hesitant-type | 12.14 | BLUF. Types `repoloop.sh / renders films.`, corrects to `spawns workers.` on the two terracotta words. Seed `repoloop-b01`. `lead_silence_s: 0.8` in beat sheet. |
