...
import {SkillTeardownAnatomy916} from './scenes/SkillTeardownAnatomy916';
import {SkillTeardownPipeline916} from './scenes/SkillTeardownPipeline916';
import {SkillTeardownMechanism916} from './scenes/SkillTeardownMechanism916';
import {ClaudeTitleOutroHAI, claudeTitleOutroHAISchema} from './scenes/ClaudeTitleOutroHAI';
import {ClaudeTitleOutroHAI916, claudeTitleOutroHAI916Schema} from './scenes/ClaudeTitleOutroHAI916';
import {HesitantWriterFramed, hesitantWriterFramedSchema} from './scenes/HesitantWriterFramed';
  ...
  return (
    <>
      ...
      <Folder name="SkillTeardown-Generic">
        ...
        <Composition id="SkillTeardownAnatomy916" component={SkillTeardownAnatomy916}
          durationInFrames={600} fps={30} width={1080} height={1920}
          schema={skillTeardownAnatomySchema}
          defaultProps={skillTeardownAnatomySchema.parse({})} />
        <Composition id="SkillTeardownPipeline916" component={SkillTeardownPipeline916}
          durationInFrames={600} fps={30} width={1080} height={1920}
          schema={skillTeardownPipelineSchema}
          defaultProps={skillTeardownPipelineSchema.parse({})} />
        <Composition id="SkillTeardownMechanism916" component={SkillTeardownMechanism916}
          durationInFrames={600} fps={30} width={1080} height={1920}
          schema={skillTeardownMechanismSchema}
          defaultProps={skillTeardownMechanismSchema.parse({})} />
        <Composition id="ClaudeTitleOutroHAI" component={ClaudeTitleOutroHAI}
          durationInFrames={180} fps={30} width={1920} height={1080}
          schema={claudeTitleOutroHAISchema}
          defaultProps={claudeTitleOutroHAISchema.parse({})} />
        <Composition id="ClaudeTitleOutroHAI916" component={ClaudeTitleOutroHAI916}
          durationInFrames={180} fps={30} width={1080} height={1920}
          schema={claudeTitleOutroHAI916Schema}
          defaultProps={claudeTitleOutroHAI916Schema.parse({})} />
        <Composition id="HesitantWriterFramed" component={HesitantWriterFramed}
          durationInFrames={606} fps={30} width={1920} height={1080}
          schema={hesitantWriterFramedSchema}
          defaultProps={hesitantWriterFramedSchema.parse({})} />
        <Composition id="HesitantWriterFramed916" component={HesitantWriterFramed}
          durationInFrames={606} fps={30} width={1080} height={1920}
          schema={hesitantWriterFramedSchema}
          defaultProps={hesitantWriterFramedSchema.parse({})} />
      </Folder>
