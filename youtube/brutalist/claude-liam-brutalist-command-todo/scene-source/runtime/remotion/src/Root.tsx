...
// ── claude-liam-brutalist-command-todo — reel-local components ──
import {
  TodoPipeline,   todoPipelineSchema,
  TodoCommand,    todoCommandSchema,
  TodoRun,        todoRunSchema,
  TodoEntry,      todoEntrySchema,
  TodoMethods,    todoMethodsSchema,
  TodoAgentLoop,  todoAgentLoopSchema,
  TodoFailure,    todoFailureSchema,
} from './CommandTodo';
...
export const RemotionRoot: React.FC = () => {
  return (
    <>
      ...
      {/* ── claude-liam-brutalist-command-todo — reel-local components ── */}
      <Folder name="ClaudeLiamCommandTodo">
        <Composition id="TodoPipeline" component={TodoPipeline}
          durationInFrames={480} fps={30} width={1920} height={1080}
          schema={todoPipelineSchema}
          defaultProps={todoPipelineSchema.parse({})} />
        <Composition id="TodoPipeline916" component={TodoPipeline}
          durationInFrames={480} fps={30} width={1080} height={1920}
          schema={todoPipelineSchema}
          defaultProps={todoPipelineSchema.parse({})} />
        <Composition id="TodoCommand" component={TodoCommand}
          durationInFrames={480} fps={30} width={1920} height={1080}
          schema={todoCommandSchema}
          defaultProps={todoCommandSchema.parse({})} />
        <Composition id="TodoCommand916" component={TodoCommand}
          durationInFrames={480} fps={30} width={1080} height={1920}
          schema={todoCommandSchema}
          defaultProps={todoCommandSchema.parse({})} />
        <Composition id="TodoRun" component={TodoRun}
          durationInFrames={540} fps={30} width={1920} height={1080}
          schema={todoRunSchema}
          defaultProps={todoRunSchema.parse({})} />
        <Composition id="TodoRun916" component={TodoRun}
          durationInFrames={540} fps={30} width={1080} height={1920}
          schema={todoRunSchema}
          defaultProps={todoRunSchema.parse({})} />
        <Composition id="TodoEntry" component={TodoEntry}
          durationInFrames={540} fps={30} width={1920} height={1080}
          schema={todoEntrySchema}
          defaultProps={todoEntrySchema.parse({})} />
        <Composition id="TodoEntry916" component={TodoEntry}
          durationInFrames={540} fps={30} width={1080} height={1920}
          schema={todoEntrySchema}
          defaultProps={todoEntrySchema.parse({})} />
        <Composition id="TodoMethods" component={TodoMethods}
          durationInFrames={540} fps={30} width={1920} height={1080}
          schema={todoMethodsSchema}
          defaultProps={todoMethodsSchema.parse({})} />
        <Composition id="TodoMethods916" component={TodoMethods}
          durationInFrames={540} fps={30} width={1080} height={1920}
          schema={todoMethodsSchema}
          defaultProps={todoMethodsSchema.parse({})} />
        <Composition id="TodoAgentLoop" component={TodoAgentLoop}
          durationInFrames={540} fps={30} width={1920} height={1080}
          schema={todoAgentLoopSchema}
          defaultProps={todoAgentLoopSchema.parse({})} />
        <Composition id="TodoAgentLoop916" component={TodoAgentLoop}
          durationInFrames={540} fps={30} width={1080} height={1920}
          schema={todoAgentLoopSchema}
          defaultProps={todoAgentLoopSchema.parse({})} />
        <Composition id="TodoFailure" component={TodoFailure}
          durationInFrames={480} fps={30} width={1920} height={1080}
          schema={todoFailureSchema}
          defaultProps={todoFailureSchema.parse({})} />
        <Composition id="TodoFailure916" component={TodoFailure}
          durationInFrames={480} fps={30} width={1080} height={1920}
          schema={todoFailureSchema}
          defaultProps={todoFailureSchema.parse({})} />
      </Folder>
