...
export const GodotDesignBoard:React.FC<z.infer<typeof godotDesignBoardSchema>>=(p)=>{
 ...
 return <AbsoluteFill style={{background:C.PAGE,color:C.INK,fontFamily:F.ui}}>
  <div style={{position:'absolute',top:height*.045,left:pad,right:pad,fontFamily:F.serif,fontSize:portrait?60:59,lineHeight:1.12}}>{p.title}</div>
  ...
  <div style={{position:'absolute',right:pad,bottom:height*.045+(portrait?45:0),fontSize:28,fontFamily:F.serif}}>@NikBearBrown</div>
 </AbsoluteFill>;
};
