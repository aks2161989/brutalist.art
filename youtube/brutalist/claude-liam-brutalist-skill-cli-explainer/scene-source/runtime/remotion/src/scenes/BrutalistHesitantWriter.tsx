...
export const BrutalistHesitantWriter: React.FC<BrutalistHesitantWriterProps> = (props) => {
  ...
  // Everything scales off the canvas against the aspect's design reference.
  // Portrait uses 1080x1920 as its design reference so serif fills SAFE916
  // (see memory: hesitant-writer-portrait-scale).
