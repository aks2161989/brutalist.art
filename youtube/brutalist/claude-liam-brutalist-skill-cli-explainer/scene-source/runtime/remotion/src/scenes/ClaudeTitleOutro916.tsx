...
export const ClaudeTitleOutro916: React.FC<ClaudeTitleOutro916Props> = ({ title, slug, handle }) => {
  ...
  return (
    <AbsoluteFill style={{
      ...
      {/* Handle — @NikBearBrown by default; playlist adaptation lets the
          beat sheet override with @HumanitariansAI (isolated toolkit only). */}
      <div style={{
        fontFamily: SERIF,
