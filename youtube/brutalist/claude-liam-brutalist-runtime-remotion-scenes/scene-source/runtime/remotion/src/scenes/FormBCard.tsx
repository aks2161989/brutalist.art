...
export const FormBCard: React.FC<FormBCardProps> = ({ title, items, dark }) => {
  ...
  return (
    <AbsoluteFill style={{ background: bg, alignItems: 'center', justifyContent: 'center' }}>
      {/* Ink-extent anchors for Gate V — invisible to human eye, detectable by ink scanner */}
      <div style={{ position: 'absolute', top: '5%', left: '5%', right: '5%', height: 3, background: fg, opacity: 0.4 }} />
      <div style={{ position: 'absolute', bottom: '5%', left: '5%', right: '5%', height: 3, background: fg, opacity: 0.4 }} />
      <div style={{
        display: 'flex', flexDirection: 'column',
