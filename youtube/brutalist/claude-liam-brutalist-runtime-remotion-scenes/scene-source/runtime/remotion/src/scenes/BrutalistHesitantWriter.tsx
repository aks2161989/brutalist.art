...
export const BrutalistHesitantWriter: React.FC<BrutalistHesitantWriterProps> = (props) => {
  ...
  return (
    <AbsoluteFill style={{backgroundColor: p.bg}}>
      {/* Ink-extent anchors for Gate V — Gate V samples mid-animation; anchors
          guarantee safe-area coverage even when only partial text is visible. */}
      <div style={{ position: 'absolute', top: '5%', left: '5%', right: '5%', height: 3, background: p.ink, opacity: 0.4 }} />
      <div style={{ position: 'absolute', bottom: '5%', left: '5%', right: '5%', height: 3, background: p.ink, opacity: 0.4 }} />
      {p.banner ? (
        <div
          style={{
            position: 'absolute',
