# TYPECHECK — Brutalist Utility: capture_sim.py (landscape)
...
In place of the missing legacy checker, typography is reviewed by direct frame inspection on the compiled 3840×2160 master. Every beat is checked against the shipping component's design tokens (Claude palette `#FAF9F5` ground, `#2F2A26` ink, `#C8102E` accent) and the Brutalist safe-area rules.
...
6. **Safe-area** — landscape SAFE1610 (x=64, y=48, w=1792, h=984 in design units); no ink outside.
