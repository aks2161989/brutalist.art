...
`8208b851…`; supervisor `episode.source_sha256`
`9439e59c…`). No numbers, quotes or mechanisms are invented.
...
| B07 | "There is no share to hit… any prior guidance stating a target percentage of vox body beats is superseded by this law." | §"VOX LAW — a still is EVIDENCE, never texture" |
